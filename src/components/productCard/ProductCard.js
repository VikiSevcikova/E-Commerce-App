    ...
    <div className="col-md-3">
      <div className="card border-0" style={{ width: "100%" }} href="#">
        <div className="product-image">
          <a href="#">
            <img src={product} className="card-img-top rounded-0" alt="p1" />
          </a>
          <div className="quick-add-overlay rounded py-2 px-2">
            ...
            <div className="btn-toolbar text-center well">
              <button
                type="button"
                className="btn btn-sm btn-outline-dark col-xs-2 me-1"
              >
                XS
              </button>
              <button
              ...
              <button
                type="button"
                className="btn btn-sm btn-outline-dark col-xs-2"
              >
                XL
              </button>
            </div>
